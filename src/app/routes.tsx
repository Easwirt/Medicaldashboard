  ...
  return (
    <div className="min-h-screen bg-[#f0f4f8]">
      <header className="bg-white border-b border-[#dde3ea] px-6 py-3 flex items-center gap-3">
        <div className="w-8 h-8 rounded-lg overflow-hidden bg-[#2563eb] flex items-center justify-center">
          <img
            src="/logo.png"
            alt="Disease Analyzer logo"
        ...
        <span className="text-[#1e293b]" style={{ fontSize: '1.125rem', fontWeight: 600 }}>Disease Analyzer</span>
